...
const MyMenu = () => {
	...
	const FollowersIcon = ({ active }: { active: boolean }) => (
		<svg
			className="com-icon"
		...
		>
			<g>
				<path d="M52.25,64.001c0,34.601,28.149,62.749,62.75,62.749c34.602,0,62.751-28.148,62.751-62.749
      S149.602,1.25,115,1.25C80.399,1.25,52.25,29.4,52.25,64.001z" />
				<path d="M217.394,262.357c2.929,2.928,6.768,4.393,10.606,4.393c3.839,0,7.678-1.465,10.607-4.394
	...
	const FollowingsIcon = ({ active }: { active: boolean }) => (
		<svg
			className="com-icon"
			fill={active ? 'white' : 'currentColor'}
			height="18px"
		...
		>
			<g>
				<path d="M177.75,64.001C177.75,29.4,149.601,1.25,115,1.25c-34.602,0-62.75,28.15-62.75,62.751
      S80.398,126.75,115,126.75C149.601,126.75,177.75,98.602,177.75,64.001z" />
				<path d="M228.606,181.144c-5.858-5.857-15.355-5.858-21.214-0.001c-5.857,5.857-5.857,15.355,0,21.214
      ...
      L228.606,181.144z" />
				<path d="M223,116.75c-34.488,0-65.145,16.716-84.298,42.47c-7.763-1.628-15.694-2.47-23.702-2.47
	...
	return (
		<Stack width={'100%'} padding={'18px'} className="my-menu-v2">
			{/* PROFILE CARD */}
			...
			<Stack className={'sections'}>
				{/* MANAGE LISTINGS */}
				<Stack className={'section'} style={{ height: 'auto' }}>
					...
					<List className={'sub-section'}>
								...
								<ListItem className={pathname === 'addProperty' ? 'focus' : ''}>
									...
									>
										<div className={'flex-box'}>
											...
											<IconButton aria-label="badge" className="menu-badge">
												<PortraitIcon />
											</IconButton>
										</div>
									</Link>
						...
						<ListItem className={pathname === 'followers' ? 'focus menu-glass-active' : 'menu-glass'}>
							<Link
								href={{
									pathname: '/mypage',
								...
								scroll={false}
							>
								<div className="flex-box menu-row">
									<div className={category === 'followers' ? 'menu-icon active' : 'menu-icon'}>
										<FollowersIcon active={category === 'followers'} />
									</div>
									...
									{category === 'followers' && <span className="menu-dot" />}
								</div>
							</Link>
						</ListItem>

						<ListItem className={pathname === 'followings' ? 'focus menu-glass-active' : 'menu-glass'}>
							<Link
								href={{
									pathname: '/mypage',
							...
							>
								<div className="flex-box menu-row">
									<div className={category === 'followings' ? 'menu-icon active' : 'menu-icon'}>
										<FollowingsIcon active={category === 'followings'} />
									</div>
									...
									{category === 'followings' && <span className="menu-dot" />}
								</div>
							</Link>
						</ListItem>
				...
				<Stack className={'section'} sx={{ marginTop: '16px' }}>
					...
					<List className={'sub-section'}>
						...
						<ListItem onClick={logoutHandler} className="logout-row">
							<div className={'flex-box'}>
